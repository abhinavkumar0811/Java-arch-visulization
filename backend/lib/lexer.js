...
const KEYWORDS = new Set([
  'class', 'public', 'private', 'protected', 'static', 'final', 'abstract', 'interface', 'implements', 'void',
  'int', 'double', 'float', 'long', 'boolean', 'char', 'String', 'Math', 'Exception', 'Throwable', 'RuntimeException',
  'new', 'return', 'if', 'else', 'while', 'for', 'break', 'continue', 'switch', 'case', 'default',
  'true', 'false', 'null', 'this', 'super', 'Thread', 'Runnable', 'System', 'out', 'println', 'print',
  'try', 'catch', 'finally', 'throw', 'throws', 'instanceof', 'extends'
]);
