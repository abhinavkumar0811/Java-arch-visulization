...
export default function App() {
  ...
  const activeLine = current?.threads
    ? Object.values(current.threads).find(t => t.id === current.threadId)?.callStack?.slice(-1)[0]?.line
    : null;
      ...
      <header className="app-header">
        <div className="brand">
          ...
          <div>
            ...
            <p className="subtitle">Step-by-step Java execution — Method Area · Heap · Stack · Threads</p>
          </div>
        </div>
